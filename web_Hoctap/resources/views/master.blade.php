        ...
        <div class="container">
            <div class="pull-left auto-width-left">
                <ul class="top-menu menu-beta l-inline">
                    <li><a href=""><i class="fa fa-home"></i> Đại chỉ cty xxxx </a></li>
                    <li><a href=""><i class="fa fa-phone"></i> 098xxxxx</a></li>
                </ul>
            </div>
        ...
        <div class="container">
            ...
            <nav class="main-menu">
                <ul class="l-inline ov">
                    ...
                    <li><a href="about.html">Tài liệu</a></li>
                    <li><a href="contacts.html">Hỏi đáp</a></li>
                </ul>
                <div class="clearfix"></div>
            </nav>
        </div> <!-- .container -->
            ...
            <div class="col-sm-3">
                <div class="widget">
                    <div class="panel-body">
                        <h1>Hệ thống Học tập trực tuyến Study </h1>
                        <div class="brief">Được xây dựng nhằm mục tiêu đồng hành cùng các bạn học sinh trong quá trình học tập, trau dồi kiến thức, kỹ năng, định hướng nghề nghiệp ...</div>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
